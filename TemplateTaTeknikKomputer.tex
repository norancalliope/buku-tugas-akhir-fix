...
\JudulTAInd{PENGEMBANGAN SISTEM KENDALI KURSI RODA BERBASIS SIBI DAN \emph{BRAKING SYSTEM} MENGGUNAKAN LSTM dan YOLOv11}
...
\cleardoublepage
\input{BiografiPenulis/biografi-penulis.tex}
\cleardoublepage
\end{document}
