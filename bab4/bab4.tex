...
\begin{figure} [H] \centering
  \includegraphics[scale=0.25]{gambar/confusion_matrix-epoch 100.png}
  \caption{ \emph{Confusion matrix epoch} 100}
  \label{fig:Cm epoch 100}
\end{figure}
Dari gambar \ref{fig:Cm epoch 100} hasil pelatihan menunjukan dua kelas yakni manusia dan \emph{background}.
...
\begin{figure} [H] \centering
  \includegraphics[scale=0.35]{gambar/F1_curve-100.png}
...
\begin{figure} [H] \centering
  \includegraphics[scale=0.3]{gambar/0-clear.jpg}
...
\begin{figure} [H] \centering
  \includegraphics[scale=0.3]{gambar/1.jpg}
...
\begin{table}[H]
  \centering
  \caption{Tabel Performa Keberhasilan Pengereman Otomatis menggunakan YOLOv8}
